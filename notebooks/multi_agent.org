#+TITLE: Multi-agent
#+property: header-args:jupyter-python+ :session multi-agent :kernel ai-agents-crash-course-aJYnLVQA-py3.13 :display plain
...
* Multi Agent
:PROPERTIES:
:CUSTOM_ID: multi-agent
:END:

[[file:media/multi_agent_overview.png]]
